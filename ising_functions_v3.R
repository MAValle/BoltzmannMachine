...
# # # # # # # # # # # ## # # # BOLTZMANN-LEARNING # ## # # # # ## # # # # ## # # # # ##  # # # # ## 
bmachine <- function(condInitial, muestra, Kmax, LearningRate, decay, N_sa, umbral, every) {
  library(progress)
  #require(ggplot2)
  #library(latex2exp)
  #library(ggthemes)
  ...
  while (epoch <= Kmax) {
    ...
    sampling <- metropolis.sampling(magnetizaciones=H, acoples = J, initial_spin = initial_spins, kmax=20000, ks=0, To=NULL, alpha=NULL)
